const metrics = [
  ...
  { value: "100+", label: "Public GitHub contributions this year" },
] as const;
    ...
    <section className="border-b border-border" aria-label="Selected milestones">
      <div className="site-container grid sm:grid-cols-3">
        {metrics.map((metric, index) => (
          <div
            key={metric.label}
            className="group border-b border-border py-6 transition-colors last:border-b-0 hover:bg-foreground hover:text-background sm:border-r sm:border-b-0 sm:px-6 sm:first:pl-0 sm:last:border-r-0"
          >
