...
export const ContributionGraphCalendar = ({
  ...
  return (
    <div
      className={cn(
        "no-scrollbar max-w-full scroll-fade-x overflow-x-auto overflow-y-hidden focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground",
        className
      )}
      tabIndex={0}
      aria-label={title}
