    ...
    >
      ...
      <div className="grid grid-cols-1 mt-3 md:grid-cols-3 w-full font-semibold text-xl">
        ...
        <div className="py-4 md:py-2">
          ...
          <div className="flex justify-start space-x-6">
            <div>
              <img src={skills[3].image} alt="Node Icon" className="h-14" />
            </div>
            <div>
              <img
                src={skills[4].image}
          ...
          <div className="flex justify-start space-x-6 mt-2">
            <div>
              <img src={skills[6].image} alt="PHP Icon" className="w-14 h-14" />
            </div>
            <div>
              <img
                src={skills[7].image}
        ...
        <div className="py-4 md:py-2">
          ...
          <div className="flex justify-start space-x-6">
            <div>
              <img src={skills[8].image} alt="Git Icon" className="w-14 h-14" />
            </div>
            <div>
              <img
                src={skills[9].image}
          ...
          <div className="flex justify-start space-x-9 mt-2 ml-2">
            <div>
              <img src={skills[11].image} alt="Figma Icon" className="h-14" />
            </div>
            <div>
              <img
                src={skills[12].image}
