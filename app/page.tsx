...
export default function Home() {
  ...
  const personJsonLd = {
    ...
    image: "https://matejbendik.com/images/matej-bendik.webp",
    ...
    <>
      ...
      <section className="border-y border-border bg-foreground text-background">
        <div className="site-container grid gap-12 py-20 sm:py-28 lg:grid-cols-[.8fr_1.2fr] lg:items-start">
          <Reveal>
            <p className="font-mono text-xs uppercase tracking-[0.2em] text-background/55">About / 02</p>
      ...
      <section className="site-container py-20 sm:py-28" aria-labelledby="latest-notes">
        <Reveal className="mb-12 grid gap-5 lg:grid-cols-2 lg:items-end">
          <div>
            <p className="font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">Writing / 03</p>
